...
pub use baseline::{
    PreparedDirectoryMetadata, PreparedNodeMetadata, parse_raw_node_spec, prepare_baselines,
    prepared_metadata_path, remove_if_exists, safe_node_file_stem, write_prepared_metadata,
};
...
pub use compare::{
    ...
    release_result_for_proof_check, run_compare, serialize_payload,
};
