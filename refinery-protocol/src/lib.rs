...
pub use smpc::{
    ...
    SMPC_PROTOCOL_NAME, SMPC_PROTOCOL_VERSION, SharePayload, compute_job_context_hash,
    decrypt_share_payload, encrypt_share_payload, public_key_fingerprint,
    public_key_from_private_key, sealed_packet_hash, slot_vector_hash,
    split_additive_shares, validate_private_key_bytes,
};
pub use stats::{
